...
The `laramagz-v3.2.1.zip` package contains the following files and folders.

    📒 laramagz-v3.2.1
        📂 app
            📄 app-v3.2.1.zip
        📂 database 
            📄 dblaramagz-v3.2.1.sql
        📂 documentation
            📄 documentation.html
...
== Update Guide (from v3.2.0 to v3.2.1)

- Upload `laramagz.zip` contained in the `update-v3.2.0-to-3.2.1` folder.
