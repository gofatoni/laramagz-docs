...
5. Import database `dblaramagz-v3.2.1.sql`
+
...
+
2. Upload `app-v3.2.1.zip` *outside* the public_html folder
+
image::put-app.jpg[]
+
3. Extract app-v3.2.1.zip so that the laramagz folder appears.
+
