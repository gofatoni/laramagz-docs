...
5. Import database `dblaramagz-v2.3.1.sql`
+
...
+
2. Upload `app-v2.3.1.zip` *outside* the public_html folder
+
image::put-app.jpg[align=center]
+
3. Extract app-v2.3.1.zip so that the laramagz folder appears.
+
