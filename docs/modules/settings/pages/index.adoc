...
image::site-language.webp[align=center]
...
image::service-unavailable.webp[width=800,align=center]
...
image::symlink.png[align=center]

Click to create a symlink to the storage folder.

image::storage.png[align=center]
